...
CREATE TABLE IF NOT EXISTS rpg_classes (
    ...
    strength_per_level FLOAT NOT NULL DEFAULT 0,
    dexterity_per_level FLOAT NOT NULL DEFAULT 0,
    intelligence_per_level FLOAT NOT NULL DEFAULT 0,
    vitality_per_level FLOAT NOT NULL DEFAULT 0,
