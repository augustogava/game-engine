...
export const AP_VS_PITCH_GAIN = 0.00035;
export const AP_VS_PITCH_MAX = 0.18;
export const AP_VS_DEFAULT_FPM = 500;
export const AP_PITCH_RATE_DAMP_GAIN = 0.6;
export const AP_PITCH_RATE_MAX_RAD_PER_S = 0.6;
export const AP_PITCH_RATE_FILTER_TAU_S = 0.15;
export const AP_ALT_TO_VS_GAIN_FPM_PER_FT = 0.9;
export const AP_ALT_MAX_VS_FPM = 1500;
