...
export const CONTRAIL_PARTICLE_CAPACITY = 18000;
export const CONTRAIL_EMIT_RATE_MAX = 420;
export const CONTRAIL_MIN_LIFETIME_S = 35;
export const CONTRAIL_MAX_LIFETIME_S = 60;
export const CONTRAIL_MIN_SIZE_INITIAL_M = 0.5;
export const CONTRAIL_MAX_SIZE_INITIAL_M = 1.0;
export const CONTRAIL_FINAL_SIZE_MULTIPLIER = 4.5;
export const CONTRAIL_INITIAL_ALPHA = 0.95;
export const CONTRAIL_MIN_DRIFT_MS = 0.02;
export const CONTRAIL_MAX_DRIFT_MS = 0.12;
...
export const CONTRAIL_WAKE_SINK_RATE_MS = 0.25;
export const CONTRAIL_NOISE_STRENGTH_LATERAL = 0.6;
export const CONTRAIL_NOISE_STRENGTH_VERTICAL = 0.35;
export const CONTRAIL_NOISE_ANIMATION_SPEED = 0.25;
export const CONTRAIL_NOISE_TEXTURE_SIZE = 256;
